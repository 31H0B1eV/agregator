...
class FeedController extends \BaseController {
    ...
    const LIGA = 'http://news.liga.net/all/rss.xml';
	...
	public function index()
	{
        ...
        list($json_lenta_data,
            $json_unian_data,
            $json_lifenews_data,
            $json_rusvesna_data,
            $json_censor_data,
            $json_liga_data) = $this->parser($data);
    ...
    public function parser($data)
    {
        ...
        $json_liga_data = $data->parseXML(self::LIGA);
        ...
        return array($json_unian_data, $json_liga_data, $json_lenta_data, $json_lifenews_data, $json_rusvesna_data, $json_censor_data);
    }
     ...
     * @return array
     */
    public function createArrayFromJsonObject($unian, $lifenews, $novorossia, $lenta, $rusvesna, $censor)
    {
        ...
        return array_merge_recursive(json_decode(json_encode($unian, JSON_UNESCAPED_UNICODE), true),
                                    ...
                                    json_decode(json_encode($novorossia, JSON_UNESCAPED_UNICODE), true),
